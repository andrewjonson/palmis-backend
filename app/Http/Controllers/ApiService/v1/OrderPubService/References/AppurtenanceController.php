...
use App\Services\ApiService\v1\OrderPubService\References\Appurtenance;

class AppurtenanceController extends Controller
{
    use ConsumeExternalService;

    public function __construct(Appurtenance $apiService)
    {
        ...
        $this->middleware('permission:appurtenance-update|admin', [
            'only' => [
                'update',
                'restore'
            ]
        ]);
        $this->middleware('permission:appurtenance-delete|admin', [
            'only' => [
                'delete',
                'forceDelete'
            ]
