...
use App\Services\ApiService\v1\MpisService\References\Insurance;
...
class InsuranceController extends Controller
{
    ...
    public function __construct(Insurance $apiService)
    {
        ...
        $this->middleware('permission:insurance-update|admin', [
            'only' => [
                'update',
                'restore'
            ]
        ]);
        $this->middleware('permission:insurance-delete|admin', [
            'only' => [
                'delete',
                'forceDelete'
            ]
