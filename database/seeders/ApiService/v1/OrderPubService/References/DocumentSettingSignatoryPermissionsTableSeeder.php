...
class DocumentSettingSignatoryPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'documentsettingsignatory-read',
        'documentsettingsignatory-create',
        'documentsettingsignatory-update',
        'documentsettingsignatory-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'DocumentSettingSignatory';
