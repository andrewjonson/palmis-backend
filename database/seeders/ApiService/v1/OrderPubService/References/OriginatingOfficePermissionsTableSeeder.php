...
class OriginatingOfficePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'originatingoffice-read',
        'originatingoffice-create',
        'originatingoffice-update',
        'originatingoffice-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'OriginatingOffice';
