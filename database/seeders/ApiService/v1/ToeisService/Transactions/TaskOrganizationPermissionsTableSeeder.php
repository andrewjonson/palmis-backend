...
class TaskOrganizationPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'taskorganization-read',
        'taskorganization-create',
        'taskorganization-update',
        'taskorganization-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'TaskOrganization';
        $this->moduleName = 'toeisservice\transactions/taskorganizationpermissionstableseeder';
    }
}
