...
class CommandAssignmentPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'commandassignment-read',
        'commandassignment-create',
        'commandassignment-update',
        'commandassignment-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'CommandAssignment';
