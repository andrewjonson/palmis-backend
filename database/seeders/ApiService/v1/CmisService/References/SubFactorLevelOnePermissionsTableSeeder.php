...
namespace Database\Seeders\ApiService\v1\CmisService\References;
...
class SubFactorLevelOnePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'subfactorlevelone-read',
        'subfactorlevelone-create',
        'subfactorlevelone-update',
        'subfactorlevelone-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'SubFactorLevelOne';
