...
class AppurtenanceAwardPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'appurtenanceaward-read',
        'appurtenanceaward-create',
        'appurtenanceaward-update',
        'appurtenanceaward-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'AppurtenanceAward';
