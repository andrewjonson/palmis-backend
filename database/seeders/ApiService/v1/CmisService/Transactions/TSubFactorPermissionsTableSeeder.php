...
class TSubFactorPermissionsTableSeeder extends Seeder
{
    ...
    )
    {
        ...
        $this->modelName = 'TSubFactor';
        $this->moduleName = 'cmisservice\transactions/tsubfactorpermissionstableseeder';
    }
}
