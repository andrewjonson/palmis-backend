...
class BranchOfServicePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'branchofservice-read',
        'branchofservice-create',
        'branchofservice-update',
        'branchofservice-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'BranchOfService';
