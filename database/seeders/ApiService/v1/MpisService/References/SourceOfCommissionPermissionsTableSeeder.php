...
class SourceOfCommissionPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'sourceofcommission-read',
        'sourceofcommission-create',
        'sourceofcommission-update',
        'sourceofcommission-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'SourceOfCommission';
