...
class PersonnelRankPermissionsTableSeeder extends Seeder
{
    ...
    )
    {
        ...
        $this->modelName = 'PersonnelRank';
        $this->moduleName = 'mpisservice\transactions/personnelrankpermissionstableseeder';
    }
}
