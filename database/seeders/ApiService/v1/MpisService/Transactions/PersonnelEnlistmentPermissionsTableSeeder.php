...
class PersonnelEnlistmentPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personnelenlistment-read',
        'personnelenlistment-create',
        'personnelenlistment-update',
        'personnelenlistment-delete'
    ];
