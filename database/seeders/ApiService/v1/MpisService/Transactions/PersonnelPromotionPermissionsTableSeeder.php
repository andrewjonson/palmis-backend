...
class PersonnelPromotionPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personnelpromotion-read',
        'personnelpromotion-create',
        'personnelpromotion-update',
        'personnelpromotion-delete'
    ];
