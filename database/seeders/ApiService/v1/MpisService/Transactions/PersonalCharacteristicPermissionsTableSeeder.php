...
class PersonalCharacteristicPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personalcharacteristic-read',
        'personalcharacteristic-create',
        'personalcharacteristic-update',
        'personalcharacteristic-delete'
    ];
