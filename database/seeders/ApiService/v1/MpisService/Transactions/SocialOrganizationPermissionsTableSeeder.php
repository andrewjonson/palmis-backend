...
class SocialOrganizationPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'socialorganization-read',
        'socialorganization-create',
        'socialorganization-update',
        'socialorganization-delete'
    ];
