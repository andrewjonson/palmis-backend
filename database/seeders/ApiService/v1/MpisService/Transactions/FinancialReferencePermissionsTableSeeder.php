...
class FinancialReferencePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'financialreference-read',
        'financialreference-create',
        'financialreference-update',
        'financialreference-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'FinancialReference';
        $this->moduleName = 'mpisservice\transactions/financialreferencepermissionstableseeder';
    }
}
