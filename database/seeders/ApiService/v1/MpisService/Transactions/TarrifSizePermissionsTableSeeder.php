...
class TarrifSizePermissionsTableSeeder extends Seeder
{
    ...
    )
    {
        ...
        $this->modelName = 'TarrifSize';
        $this->moduleName = 'mpisservice\transactions/tarrifsizepermissionstableseeder';
    }
}
