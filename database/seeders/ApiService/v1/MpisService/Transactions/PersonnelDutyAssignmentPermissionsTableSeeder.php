...
class PersonnelDutyAssignmentPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personneldutyassignment-read',
        'personneldutyassignment-create',
        'personneldutyassignment-update',
        'personneldutyassignment-delete'
    ];
