...
class PersonnelUnitPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personnelunit-read',
        'personnelunit-create',
        'personnelunit-update',
        'personnelunit-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'PersonnelUnit';
        $this->moduleName = 'mpisservice\transactions/personnelunitpermissionstableseeder';
    }
}
