...
class ResponsibilityCodePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'responsibilitycode-read',
        'responsibilitycode-create',
        'responsibilitycode-update',
        'responsibilitycode-delete'
    ];
