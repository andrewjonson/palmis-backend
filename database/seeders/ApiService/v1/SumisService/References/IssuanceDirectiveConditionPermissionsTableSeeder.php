...
class IssuanceDirectiveConditionPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'issuancedirectivecondition-read',
        'issuancedirectivecondition-create',
        'issuancedirectivecondition-update',
        'issuancedirectivecondition-delete'
    ];
