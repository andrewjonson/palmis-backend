...
class AmmunitionNomenclaturePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'ammunitionnomenclature-read',
        'ammunitionnomenclature-create',
        'ammunitionnomenclature-update',
        'ammunitionnomenclature-delete'
    ];
