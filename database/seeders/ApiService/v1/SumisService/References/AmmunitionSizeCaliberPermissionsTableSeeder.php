...
class AmmunitionSizeCaliberPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'ammunitionsizecaliber-read',
        'ammunitionsizecaliber-create',
        'ammunitionsizecaliber-update',
        'ammunitionsizecaliber-delete'
    ];
