...
class IssuanceDirectivePurposePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'issuancedirectivepurpose-read',
        'issuancedirectivepurpose-create',
        'issuancedirectivepurpose-update',
        'issuancedirectivepurpose-delete'
    ];
