...
class AmmunitionHeadStumpMarkingPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'ammunitionheadstumpmarking-read',
        'ammunitionheadstumpmarking-create',
        'ammunitionheadstumpmarking-update',
        'ammunitionheadstumpmarking-delete'
    ];
