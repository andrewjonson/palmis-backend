...
class IssuanceDirectivePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'issuancedirective-read',
        'issuancedirective-create',
        'issuancedirective-update',
        'issuancedirective-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'IssuanceDirective';
