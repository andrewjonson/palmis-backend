...
namespace Database\Seeders\ApiService\v1\SumisService\Transactions;
...
class IssuanceDirectiveItemPermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'issuancedirectiveitem-read',
        'issuancedirectiveitem-create',
        'issuancedirectiveitem-update',
        'issuancedirectiveitem-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'IssuanceDirectiveItem';
