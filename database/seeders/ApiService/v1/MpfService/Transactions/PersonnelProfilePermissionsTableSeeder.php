...
class PersonnelProfilePermissionsTableSeeder extends Seeder
{
    use RestfulPermissionSeederTrait;

    protected $permissions = [
        'personnelprofile-read',
        'personnelprofile-create',
        'personnelprofile-update',
        'personnelprofile-delete'
    ];
    ...
    )
    {
        ...
        $this->modelName = 'PersonnelProfile';
        $this->moduleName = 'mpf';
    }
}
